...
var LearningObject = React.createClass({
  ...
  _setUserAnswer: function ( answer ){

    this.state.userAnswer.push(answer);
  },

  _onAdaptCallback: function(){
  ...
  */
  _onChooseAnswer: function( qtype, qindex, choice, correct , q){
  ...
  _finishOneQ: function(qindex, answers, userChoices){
  ...
  _getQuizesComponent: function(quizs){
            ...
            answerComponent = q.choices.map(function (c, j){
                ...
                return (
                    <Col xs={12} className="lo-answer" id={ "lo-answer-" + i + "-" +j }>
                      <div dangerouslySetInnerHTML={{ __html: c.content }} onClick={ self._onChooseAnswer.bind(this, q.qtype ,i, j, q.answer, q.question) }/>
                    </Col>
                  );
            });
            ...
            answerComponent = (
               <Row> 
                 <Col xs={9} id={ "lo-answer-" + i}>
                  <Radio value='Yes' name="answeryesno" onClick={ self._onChooseAnswer.bind(this, q.qtype ,i, 'yes', q.answer, q.question) }>
                    Yes
                  </Radio>
                  <Radio value='No' name="answeryesno" onClick={ self._onChooseAnswer.bind(this, q.qtype ,i, 'no', q.answer,q.question) }>
                    No
                  </Radio>
                </Col>
              </Row>);
             ...
             answerComponent = (
               <Row> 
                  <Col xs={10} className="" id={ "lo-answer-" + i}>
                    <Input type='text' id='textAnswerInput' name='comment' placeholder="Please input your comment here!" className='required' /> 
                  </Col>
                  <Col xs={2}>
                    <Button bsStyle='xddgreen' onClick={ self._onChooseAnswer.bind(this, q.qtype ,i, '', q.answer, q.question) }><Entity entity='confirm'/></Button>
                  </Col>
                </Row>
            );
          ...
          return (
              <Panel>
                <PanelBody>
                  <Row>
                    <Col xs={12}>
                      <Entity entity="question" />: {{ i }}: <div dangerouslySetInnerHTML={{__html: q.question }} />
                    </Col> 
                  </Row>
                  <Row>
                ...
                <PanelBody>
                  ...
                  <Row>
                    <Col xs={12} className="text-center">
                      <Button bsStyle='xddgreen' onClick={ this._onAdapt.bind(this, lo.id, lo.title) }><Entity entity='continueLO'/></Button>
                    </Col>
                </Row> 
                </PanelBody>
              </Panel>
